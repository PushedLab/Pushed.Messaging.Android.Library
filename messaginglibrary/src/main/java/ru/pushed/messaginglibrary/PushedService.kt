...
class PushedService(private val context : Context, messageReceiverClass: Class<*>?) {
    ...
    private fun getNewToken():String?{
        ...
        if(fcmToken!=null) deviceSettings.put(JSONObject().put("deviceToken",fcmToken).put("transportKind","Fcm"))
        if(hpkToken!=null) deviceSettings.put(JSONObject().put("deviceToken",hpkToken).put("transportKind","Hpk"))
        if(ruStoreToken!=null) deviceSettings.put(JSONObject().put("deviceToken",ruStoreToken).put("transportKind","RuStore"))
